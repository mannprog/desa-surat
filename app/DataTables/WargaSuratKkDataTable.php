...
class WargaSuratKkDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($row) {
            return view('auth.warga.pages.surat.kk.component.action', compact('row'))->render();
        })
     ...
     */
    public function query(SuratKk $model): QueryBuilder
    {
        $userId = Auth::id();
    ...
    {
        return 'WargaSuratKk_' . date('YmdHis');
    }
}
