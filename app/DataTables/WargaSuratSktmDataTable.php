...
class WargaSuratSktmDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                return view('auth.warga.pages.surat.sktm.component.action', compact('row'))->render();
            })
    ...
    {
        return $this->builder()
                    ->setTableId('wargasuratsktm-table')
    ...
    {
        return 'WargaSuratSktm_' . date('YmdHis');
    }
}
