...
class AdminSuratKtpDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($row) {
            return view('auth.admin.pages.surat.ktp.component.action', compact('row'))->render();
        })
    ...
    {
        return $this->builder()
                    ->setTableId('adminsuratktp-table')
    ...
    {
        return 'AdminSuratKtp_' . date('YmdHis');
    }
}
