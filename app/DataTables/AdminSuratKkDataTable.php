...
class AdminSuratKkDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($row) {
            return view('auth.admin.pages.surat.kk.component.action', compact('row'))->render();
        })
    ...
    {
        return 'AdminSuratKk_' . date('YmdHis');
    }
}
