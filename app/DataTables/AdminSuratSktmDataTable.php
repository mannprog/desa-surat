...
class AdminSuratSktmDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($row) {
            return view('auth.admin.pages.surat.sktm.component.action', compact('row'))->render();
        })
    ...
    {
        return $this->builder()
                    ->setTableId('adminsuratsktm-table')
    ...
    {
        return 'AdminSuratSktm_' . date('YmdHis');
    }
}
