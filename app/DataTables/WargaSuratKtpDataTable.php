...
class WargaSuratKtpDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($row) {
            return view('auth.warga.pages.surat.ktp.component.action', compact('row'))->render();
        })
     ...
     */
    public function query(SuratKtp $model): QueryBuilder
    {
        $userId = Auth::id();
    ...
    {
        return $this->builder()
                    ->setTableId('wargasuratktp-table')
    ...
    {
        return 'WargaSuratKtp_' . date('YmdHis');
    }
}
