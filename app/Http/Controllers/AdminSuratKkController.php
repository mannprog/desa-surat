...
class AdminSuratKkController extends Controller
{
    ...
    public function index(AdminSuratKkDataTable $dataTable)
    {
        ...
        return $dataTable->render('auth.admin.pages.surat.kk.index', compact(['user', 'nspktp', 'nspkk', 'nspsktm', 'nspskck', 'ndata']));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('auth.admin.pages.surat.kk.detail', compact(['data', 'nspktp', 'nspkk', 'nspsktm', 'nspskck', 'ndata']));
    }
