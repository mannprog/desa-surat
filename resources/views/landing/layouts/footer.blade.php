...
<footer id="footer">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Surat Pengantar KK</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Surat Pengantar SKTM</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Surat Pengantar SKCK</a></li>
                    </ul>
                </div>
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong><span>Marwin</span></strong>. All Rights Reserved
        </div>
    </div>
</footer><!-- End Footer -->
