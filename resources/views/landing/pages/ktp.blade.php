@extends('landing.pages.layout', ['title' => 'Surat Pengantar KTP'])
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-content">
                            <p>
                                Berikut adalah syarat dan ketentuan untuk pembuatan Surat Pengantar KTP:
                            </p>

                            <ol>
                                <li>Login dengan akun yang telah terdaftar. Jika belum memiliki registrasi akun terlebih
                                    dahulu.</li>
                                <li>Pilih menu Surat Pengantar KTP.</li>
                                <li>Isi menu form tambah pengajuan dengan upload Kartu Keluarga.</li>
                                <li>Tunggu status pengajuan, jika status telah selesai maka Surat Pengantar KTP bisa
                                    didownload.</li>
                            </ol>
