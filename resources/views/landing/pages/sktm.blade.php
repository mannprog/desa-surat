@extends('landing.pages.layout', ['title' => 'Surat Pengantar SKTM'])
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-content">
                            <p>
                                Berikut adalah syarat dan ketentuan untuk pembuatan Surat Pengantar SKTM:
                            </p>

                            <ol>
                                <li>Login dengan akun yang telah terdaftar. Jika belum memiliki registrasi akun terlebih
                                    dahulu.</li>
                                <li>Pilih menu Surat Pengantar SKTM.</li>
                                <li>Isi menu form tambah pengajuan dengan upload KTP dan upload Kartu Keluarga.</li>
                                <li>Tunggu status pengajuan, jika status telah selesai maka Surat Pengantar SKTM
                                    bisa
                                    didownload.</li>
                            </ol>
