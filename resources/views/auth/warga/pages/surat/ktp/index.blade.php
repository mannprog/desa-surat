@extends('auth.warga.layouts.app', ['title' => 'Surat Pengantar KTP'])
...
@section('content')
    ...
    @include('auth.warga.pages.surat.ktp.component.add-modal')
@endsection
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "{{ route('surat.ktp.index') }}" + '/' + warga_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
                        success: function(data) {
