@extends('auth.warga.layouts.app', ['title' => 'Detail Permohonan SPKTP'])
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <div class="row justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title">Detail Permohonan SPKTP - {{ $data->user->name }}</h1>
                </div>
                <div class="col-auto">
                    @if ($data->status === 'selesai')
                        <a href="{{ route('surat.ktp.download', $data->spktp) }}" class="btn btn-sm btn-success shadow"><i
