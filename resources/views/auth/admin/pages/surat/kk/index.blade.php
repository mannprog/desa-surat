@extends('auth.admin.layouts.app', ['title' => 'Kelola Surat Pengantar Kartu Keluarga'])
...
@section('content')
    ...
    @include('auth.admin.pages.surat.kk.component.add-modal')
@endsection
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "{{ route('pengantar.kk.index') }}" + '/' + warga_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
                        success: function(data) {
