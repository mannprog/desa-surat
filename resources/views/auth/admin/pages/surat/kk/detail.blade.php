@extends('auth.admin.layouts.app', ['title' => 'Detail Permohonan SPKK'])
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <div class="row justify-content-between">
                ...
                <div class="col-auto">
                    <a href="{{ route('pengantar.kk.index') }}" class="btn btn-sm btn-secondary shadow">
                        Kembali</a>
                </div>
            </div>
            ...
            <div class="app-card app-card-chart h-100 shadow-sm">
                @if ($data->status === 'belumditentukan')
                    <div class="app-card-header p-3">
                        ...
                        @include('auth.admin.pages.surat.kk.component.accOrRej')
                    </div>
                @elseif ($data->status === 'proses')
                    <div class="app-card-header p-3">
                        <a href="#" class="btn btn-sm btn-success shadow" data-toggle="modal"
                            ...
                            Surat</a>
                        @include('auth.admin.pages.surat.kk.component.upload')
                    </div>
                @endif
                        ...
                        <div class="col-12 col-lg-9 text-start">
                            ...
                            <div class="container">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 col-lg-8">
                                        <img src="{{ asset('file/permohonan/kk/' . $data->kk_lama) }}"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 col-lg-8">
                                        <img src="{{ asset('file/permohonan/kk/' . $data->file_pendukung) }}"
                                            class="img-fluid py-2">
                                    </div>
                                </div>
                            </div>
