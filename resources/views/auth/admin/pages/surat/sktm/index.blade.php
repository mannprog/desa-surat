@extends('auth.admin.layouts.app', ['title' => 'Kelola Surat Pengantar SKTM'])
...
@section('content')
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <div class="row justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title">Kelola Surat Pengantar SKTM</h1>
                </div>
                <div class="col-auto">
    ...
    @include('auth.admin.pages.surat.sktm.component.add-modal')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "{{ route('pengantar.sktm.store') }}",
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
                        $('#itemForm').trigger("reset");
                        $('#modal-md').modal('hide');
                        $('#adminsuratsktm-table').DataTable().draw();
                        Swal.fire({
                            icon: 'success',
                            title: 'Success',
                            text: data.message,
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "{{ route('pengantar.sktm.index') }}" + '/' + warga_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
                        success: function(data) {
