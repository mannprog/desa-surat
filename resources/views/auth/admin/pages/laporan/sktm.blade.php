@extends('auth.admin.layouts.app', ['title' => 'Laporan Surat Pengantar SKTM'])
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <div class="row justify-content-between">
                ...
                <div class="col-auto">
                    <a href="{{ route('laporan.sktm.export') }}" target="_blank" class="btn btn-sm btn-primary shadow-sm"><i
