<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="<?php echo e(asset('landing/img/logo.png')); ?>"
                    alt="logo"><span class="logo-text">PORTAL DESA CILELES</span></a>
