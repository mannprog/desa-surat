    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <div class="row justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title">Laporan Surat Pengantar SKTM</h1>
                </div>
            </div>
...
<?php echo $__env->make('auth.admin.layouts.app', ['title' => 'Laporan Surat Pengantar SKTM'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\desa-surat\resources\views/auth/admin/pages/laporan/sktm.blade.php ENDPATH**/ ?>