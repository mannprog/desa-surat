    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <div class="row justify-content-between">
                ...
                <div class="col-auto">
                    <a href="<?php echo e(route('warga.profil', auth()->user()->id)); ?>" class="btn btn-sm btn-secondary shadow-sm">
                        Kembali</a>
                </div>
            </div>
            ...
            <div class="app-card app-card-chart h-100 shadow-sm">
                <div class="app-card-body p-3 p-lg-4">
                    <form action="<?php echo e(route('update.warga.profil', $warga->id)); ?>" method="POST"
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="no_kk" name="no_kk"
                                        required value="<?php echo e(old('no_kk', $warga->wargaDetail->no_kk)); ?>">
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="pekerjaan"
                                        name="pekerjaan" value="<?php echo e(old('pekerjaan', $warga->wargaDetail->pekerjaan)); ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="pasangan"
                                        name="pasangan" value="<?php echo e(old('pasangan', $warga->wargaDetail->pasangan)); ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="gol_darah"
                                        name="gol_darah" value="<?php echo e(old('gol_darah', $warga->wargaDetail->gol_darah)); ?>">
                                </div>
                                <div class="col-lg-6">
                                    <label for="no_hp" class="form-label">No Handphone</label>
                                    <input type="text" class="form-control form-control-sm" id="no_hp"
                                        name="no_hp" value="<?php echo e(old('no_hp', $warga->wargaDetail->no_hp)); ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="ayah"
                                        name="ayah" value="<?php echo e(old('ayah', $warga->wargaDetail->ayah)); ?>">
                                </div>
                                <div class="col-lg-6">
                                    <label for="ibu" class="form-label">Nama Ibu</label>
                                    <input type="text" class="form-control form-control-sm" id="ibu"
                                        name="ibu" value="<?php echo e(old('ibu', $warga->wargaDetail->ibu)); ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input id="anak" type="hidden" name="anak" required
                                        value="<?php echo e(old('anak', $warga->wargaDetail->anak)); ?>">
...
<?php echo $__env->make('auth.warga.layouts.app', ['title' => 'Edit Profil Saya'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\desa-surat\resources\views/auth/warga/pages/profil/edit.blade.php ENDPATH**/ ?>