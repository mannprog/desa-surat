                    ...
                    <div class="app-utility-item app-user-dropdown dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                            <li><a class="dropdown-item"
                                    href="<?php echo e(route('warga.profil', auth()->user()->id)); ?>">Profil</a></li>
                            <li>
...
<?php /**PATH C:\laragon\www\desa-surat\resources\views/auth/warga/layouts/topbar.blade.php ENDPATH**/ ?>