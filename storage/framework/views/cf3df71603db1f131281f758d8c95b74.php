                ...
                <div class="app-utilities col-auto">
                    ...
                    <div class="app-utility-item app-user-dropdown dropdown pe-lg-4">
                        <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown"
                            ...
                            <span class="me-2 text-gray-600 small"><?php echo e(auth()->user()->name); ?></span>
                            <img src="<?php echo e(asset('admin/images/profiles/' . auth()->user()->foto)); ?>"
                                class="rounded-circle">
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                            <li><a class="dropdown-item"
                                    href="<?php echo e(route('admin.profil', auth()->user()->id)); ?>">Profil</a></li>
                            <li>
...
<?php /**PATH C:\laragon\www\desa-surat\resources\views/auth/admin/layouts/topbar.blade.php ENDPATH**/ ?>