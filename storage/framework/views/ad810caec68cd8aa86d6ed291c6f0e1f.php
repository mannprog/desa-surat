...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('auth.admin.pages.surat.ktp.component.add-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('pengantar.ktp.store')); ?>",
                    contentType: false,
                    processData: false,
                    type: "POST",
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "<?php echo e(route('pengantar.ktp.index')); ?>" + '/' + warga_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
                        success: function(data) {
...
<?php echo $__env->make('auth.admin.layouts.app', ['title' => 'Kelola Surat Pengantar KTP'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\desa-surat\resources\views/auth/admin/pages/surat/ktp/index.blade.php ENDPATH**/ ?>